...
def build_search_query(query: str, filters: SearchFilters, user_id: int) -> Tuple[str, dict]:
    """
...
def get_search_suggestions(db: Session, user_id: int, partial_query: str, limit: int = 5) -> List[str]:
    """
