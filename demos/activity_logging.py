...
def demo_activity_workflow():
    ...
    workflow_steps = [
        ("1. User creates task", "ActivityLogger.log_task_created()", "Logs: 'Created task: Fix authentication bug'"),
        ("2. User starts timer", "ActivityLogger.log_timer_started()", "Logs: 'Started timer for: Fix authentication bug'"),
        ("3. User works for 2 hours", "Time tracked automatically", "No activity log (time tracking is separate)"),
        ("4. User stops timer", "ActivityLogger.log_timer_stopped()", "Logs: 'Stopped timer for: Fix authentication bug (120 minutes)'"),
        ("5. User updates task", "ActivityLogger.log_task_updated()", "Logs: 'Updated task: Fix authentication bug' with changes metadata"),
        ("6. User completes task", "ActivityLogger.log_task_updated()", "Logs: 'Updated task: Fix authentication bug' with status change"),
        ("7. User archives task", "ActivityLogger.log_task_archived()", "Logs: 'Archived task: Fix authentication bug'")
    ]
