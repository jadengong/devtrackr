...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('active', 'paused', 'completed', name='time_entry_status'), server_default='active', nullable=False),
    ...
    op.create_index('ix_time_entries_owner_date', 'time_entries', ['owner_id', 'start_time'], unique=False)
    op.create_index(op.f('ix_time_entries_owner_id'), 'time_entries', ['owner_id'], unique=False)
    op.create_index('ix_time_entries_owner_status', 'time_entries', ['owner_id', 'status'], unique=False)
    ...
    op.create_index('ix_time_entries_task_start', 'time_entries', ['task_id', 'start_time'], unique=False)
